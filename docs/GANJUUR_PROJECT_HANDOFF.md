...
- **UI:** logo is `logo.jpg` (not `image_566068.jpg`). Header is logo + title only (the old 4-step flow strip was removed 2026-08-16 as too informal); tabs are labeled `1 · 📥 Зураг оруулах` … `4 · ✍️ Галиг оруулах`. Terminology is “хэсэг” (not “хүсэг”).
